package aiku_main.gmail;

import aiku_main.dto.GmailCredential;
import aiku_main.dto.GoogleTokenResponse;
...
public class GmailAPIProvider {
    ...
    public boolean sendMessage(String subject, String body, MultipartFile attachment)
